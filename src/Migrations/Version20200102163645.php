 ...
 */
final class Version20200102163645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE announcement (id INT AUTO_INCREMENT NOT NULL, userid INT DEFAULT NULL, category VARCHAR(250) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, keywords VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, detail VARCHAR(500) DEFAULT NULL, details VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, date DATETIME DEFAULT NULL, trial VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comment ADD title VARCHAR(100) DEFAULT NULL, ADD thing VARCHAR(255) DEFAULT NULL, ADD thins VARCHAR(255) DEFAULT NULL, CHANGE subject subject VARCHAR(100) DEFAULT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(10) DEFAULT NULL, CHANGE ip ip VARCHAR(50) DEFAULT NULL, CHANGE userid userid INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE newsid newsid INT DEFAULT NULL');
